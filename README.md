...
DScmd -f <file> <options>      Load a media file or media URL, render with default graph
DScmd -g <graph> <options>     Create specified DirectShow filter graph (see details below)
DScmd -grf <file> <options>    Load a GRF file
